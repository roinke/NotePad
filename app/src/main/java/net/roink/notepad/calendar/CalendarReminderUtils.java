package net.roink.notepad.calendar;
...
public class CalendarReminderUtils {
    ...
    private static String CALENDARS_NAME = "roinker";
    private static String CALENDARS_ACCOUNT_NAME = "roink.net";
    private static String CALENDARS_ACCOUNT_TYPE = "com.android.roinker";
    private static String CALENDARS_DISPLAY_NAME = "roinker账户";
     ...
     * 添加日历事件
     */
    public static int addCalendarEvent(Context context, String title, String description, long startTime, long endTime,int previousMinutes) {
        if (context == null) {
            return -1;
        }
        ...
        Uri uri = contentResolver.insert(Uri.parse(CALENDER_REMINDER_URL), values);
